...
SECRET_KEY = 'django-insecure-h$xcfqiass^zra#6u1**9$hiu9xq(p2glvw$hrs9i&fxog7^j*'
...
STATIC_ROOT = os.path.join(TEMPLATE_DIR,'collected_static')

MEDIA_URL = '/mediafiles/'
MEDIA_ROOT = os.path.join(TEMPLATE_DIR,'staticfiles/mediafiles')

STATICFILES_DIRS = [
    os.path.join(TEMPLATE_DIR,"staticfiles"),
]
